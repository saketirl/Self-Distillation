#!/bin/bash
# Analyze eigenspectrum for SFT checkpoint using cross-entropy loss
# Saves results in eigenspectrum/outputs/sft_full_mbpp/task_0_tooluse/checkpoint-127/layer_*/

set -e

MODEL_PATH="${MODEL_PATH:-/data/saket/continual/Self-Distillation/outputs/sft_full_mbpp/task_0_tooluse/checkpoint-127}"
OUTPUT_BASE="${OUTPUT_BASE:-/data/saket/continual/Self-Distillation/eigenspectrum/outputs/sft_full_mbpp/task_0_tooluse/checkpoint-127}"
...
echo "=============================================="
echo "SFT Checkpoint Eigenspectrum Analysis"
echo "=============================================="
...
if len(layers) > 0:
    ...
    axes[0].set_title('Top Eigenvalue Across Layers (SFT Checkpoint, SFT Loss)')
    ...
    axes[1].set_title('Effective Rank Across Layers (SFT Checkpoint, SFT Loss)')
